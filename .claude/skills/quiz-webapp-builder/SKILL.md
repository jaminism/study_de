...
description: "생성된 학습 문제 은행(data/questions/*.json)을 기반으로 Python 웹 애플리케이션(Flask)을 빌드한다. 객관식/주관식 문제 풀이, 채점, 카테고리 선택, 결과 리뷰 기능을 구현할 때 사용. '앱 만들어줘', '웹 서비스 빌드', '문제 풀이 화면 구현' 요청 시 반드시 이 스킬을 사용할 것."
---
